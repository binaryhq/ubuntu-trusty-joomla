...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2016 at 09:18 AM
...
CREATE TABLE `tbl_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `tbl_banner_tracks` (
...
INSERT INTO `tbl_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(9, 35, 1, 11, 12, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 718, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);
...
CREATE TABLE `tbl_content_frontpage` (
...
INSERT INTO `tbl_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
CREATE TABLE `tbl_core_log_searches` (
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"893ac0083f545b7defab2d410d5f16e1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1474528583}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
CREATE TABLE `tbl_finder_filters` (
...
CREATE TABLE `tbl_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `tbl_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tbl_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
CREATE TABLE `tbl_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `tbl_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
CREATE TABLE `tbl_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `tbl_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tbl_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
INSERT INTO `tbl_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
INSERT INTO `tbl_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
INSERT INTO `tbl_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `tbl_postinstall_messages`
--

CREATE TABLE `tbl_postinstall_messages` (
...
--
-- Dumping data for table `tbl_postinstall_messages`
--

INSERT INTO `tbl_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
CREATE TABLE `tbl_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tbl_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('0a5v2cfm1gtk12qb2f1hufjd96', 0, 1, '1474528627', 'joomla|s:1976:"";', 0, ''),
('0jv9987p490tbamllgbffgiha2', 0, 1, '1474528586', 'joomla|s:1488:"";', 0, '');
...
INSERT INTO `tbl_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 718, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `tbl_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `tbl_ucm_base`
--

CREATE TABLE `tbl_ucm_base` (
...
--
-- Table structure for table `tbl_ucm_content`
--

CREATE TABLE `tbl_ucm_content` (
...
--
-- Table structure for table `tbl_ucm_history`
--

CREATE TABLE `tbl_ucm_history` (
...
INSERT INTO `tbl_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1474528584, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1474528585, ''),
...
CREATE TABLE `tbl_update_sites_extensions` (
...
(718, 'Super User', 'USER_USERNAME', 'USER_EMAIL', 'PASSWORDHERE', 0, 1, now(), '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
...
CREATE TABLE `tbl_user_usergroup_map` (
...
--
-- Table structure for table `tbl_utf8_conversion`
--

CREATE TABLE `tbl_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tbl_utf8_conversion`
--

INSERT INTO `tbl_utf8_conversion` (`converted`) VALUES
(2);
...
--
-- Indexes for table `tbl_banner_clients`
--
ALTER TABLE `tbl_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `tbl_banner_tracks`
--
ALTER TABLE `tbl_banner_tracks`
...
--
-- Indexes for table `tbl_contentitem_tag_map`
--
ALTER TABLE `tbl_contentitem_tag_map`
...
--
-- Indexes for table `tbl_content_frontpage`
--
ALTER TABLE `tbl_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `tbl_content_rating`
--
ALTER TABLE `tbl_content_rating`
  ADD PRIMARY KEY (`content_id`);
...
--
-- Indexes for table `tbl_extensions`
--
ALTER TABLE `tbl_extensions`
...
--
-- Indexes for table `tbl_finder_filters`
--
ALTER TABLE `tbl_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `tbl_finder_links`
--
ALTER TABLE `tbl_finder_links`
...
--
-- Indexes for table `tbl_finder_links_terms0`
--
ALTER TABLE `tbl_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms1`
--
ALTER TABLE `tbl_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms2`
--
ALTER TABLE `tbl_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms3`
--
ALTER TABLE `tbl_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms4`
--
ALTER TABLE `tbl_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms5`
--
ALTER TABLE `tbl_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms6`
--
ALTER TABLE `tbl_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms7`
--
ALTER TABLE `tbl_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms8`
--
ALTER TABLE `tbl_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_terms9`
--
ALTER TABLE `tbl_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termsa`
--
ALTER TABLE `tbl_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termsb`
--
ALTER TABLE `tbl_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termsc`
--
ALTER TABLE `tbl_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termsd`
--
ALTER TABLE `tbl_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termse`
--
ALTER TABLE `tbl_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_links_termsf`
--
ALTER TABLE `tbl_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `tbl_finder_taxonomy`
--
ALTER TABLE `tbl_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_finder_taxonomy_map`
--
ALTER TABLE `tbl_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `tbl_finder_terms`
--
ALTER TABLE `tbl_finder_terms`
...
--
-- Indexes for table `tbl_finder_terms_common`
--
ALTER TABLE `tbl_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `tbl_finder_tokens`
--
ALTER TABLE `tbl_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `tbl_finder_tokens_aggregate`
--
ALTER TABLE `tbl_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `tbl_finder_types`
--
ALTER TABLE `tbl_finder_types`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_menu_types`
--
ALTER TABLE `tbl_menu_types`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_messages_cfg`
--
ALTER TABLE `tbl_messages_cfg`
...
--
-- Indexes for table `tbl_modules_menu`
--
ALTER TABLE `tbl_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `tbl_newsfeeds`
--
ALTER TABLE `tbl_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `tbl_overrider`
--
ALTER TABLE `tbl_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_postinstall_messages`
--
ALTER TABLE `tbl_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `tbl_redirect_links`
--
ALTER TABLE `tbl_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `tbl_schemas`
--
ALTER TABLE `tbl_schemas`
...
--
-- Indexes for table `tbl_template_styles`
--
ALTER TABLE `tbl_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `tbl_ucm_base`
--
ALTER TABLE `tbl_ucm_base`
...
--
-- Indexes for table `tbl_ucm_content`
--
ALTER TABLE `tbl_ucm_content`
...
--
-- Indexes for table `tbl_ucm_history`
--
ALTER TABLE `tbl_ucm_history`
...
--
-- Indexes for table `tbl_update_sites`
--
ALTER TABLE `tbl_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `tbl_update_sites_extensions`
--
ALTER TABLE `tbl_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `tbl_usergroups`
--
ALTER TABLE `tbl_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_user_keys`
--
ALTER TABLE `tbl_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `tbl_user_usergroup_map`
--
ALTER TABLE `tbl_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `tbl_viewlevels`
--
ALTER TABLE `tbl_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `tbl_banner_clients`
--
ALTER TABLE `tbl_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tbl_extensions`
--
ALTER TABLE `tbl_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `tbl_finder_filters`
--
ALTER TABLE `tbl_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_finder_links`
--
ALTER TABLE `tbl_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_finder_taxonomy`
--
ALTER TABLE `tbl_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_finder_terms`
--
ALTER TABLE `tbl_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_finder_types`
--
ALTER TABLE `tbl_finder_types`
...
--
-- AUTO_INCREMENT for table `tbl_menu_types`
--
ALTER TABLE `tbl_menu_types`
...
--
-- AUTO_INCREMENT for table `tbl_newsfeeds`
--
ALTER TABLE `tbl_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_overrider`
--
ALTER TABLE `tbl_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `tbl_postinstall_messages`
--
ALTER TABLE `tbl_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_redirect_links`
--
ALTER TABLE `tbl_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `tbl_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_template_styles`
--
ALTER TABLE `tbl_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `tbl_ucm_content`
--
ALTER TABLE `tbl_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_ucm_history`
--
ALTER TABLE `tbl_ucm_history`
...
--
-- AUTO_INCREMENT for table `tbl_update_sites`
--
ALTER TABLE `tbl_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tbl_usergroups`
--
ALTER TABLE `tbl_usergroups`
...
--
-- AUTO_INCREMENT for table `tbl_user_keys`
--
ALTER TABLE `tbl_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_user_notes`
--
ALTER TABLE `tbl_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_viewlevels`
--
ALTER TABLE `tbl_viewlevels`
